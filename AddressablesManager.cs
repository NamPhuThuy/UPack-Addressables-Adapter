...
namespace UnityEngine.AddressableAssets
{
    ...
    public static partial class AddressablesManager
    {
        ...
        private static readonly Dictionary<string, List<IResourceLocation>> _locations; // Location list by key
        private static readonly List<IResourceLocation> _noLocation;
        private static readonly Dictionary<string, Object> _assets; // Loaded assets by key
        private static readonly Dictionary<string, SceneInstance> _scenes; // Loaded scenes by key
        private static readonly Dictionary<string, List<GameObject>> _instances; // Instantiated GameObjects by key.
        private static readonly Queue<List<GameObject>> _instanceListPool; // a pool of List<GameObject> to reduce GC allocations.
        private static readonly List<GameObject> _noInstanceList;
        private static readonly List<object> _keys; // list of all known keys.
